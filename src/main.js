...
function CustomMap(opts) {
    var defaults = {
        ...
        wxAppUrl: development ? "/WeiXin" : "https://www.ipow.cn/Data_Interface/WeiXin.aspx",
        ...
        introduction: development ? "/Introduction" : "https://www.ipow.cn/HzspMapBaiduServices/api/scenic/Introduction",
...
CustomMap.prototype = {
    ...
    createrZoneList: function(zoneID, i) {
        ...
        $.post(this.opts.searchSpots, { type: "category_spots", id: zoneID }, function (data, status, xhr) {
            ...
            var secnicList = ""
            for (var index = 0; index < data.spots.length; index++) {
                secnicList += '<li id=' + data.spots[index].id + ' data-index='+i+'>' +
            ...
            $(".scenic_list_box").append(secnicList)
